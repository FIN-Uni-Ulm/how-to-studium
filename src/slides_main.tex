...
\author{Lars Pfrenger, Benjamin Chladni} % short author title is used for the slide footer but optional
...
\begin{frame}{\insertsubsection \footnotemark[1]}
    \begin{itemize}
        ...
        \item \underline{Grundlagen der der Theoretischen Informatik}
...
\begin{frame}{\insertsubsection}
    \begin{fancycolumns}[widths={30}] %TODO: Aktuellen Stundenplan einfügen wenn verfügbar (https://www.uni-ulm.de/in/fakultaet/studium/fachbereich-informatik/fuer-studierende/b-sc-informatik/)
...
\subsection{LSF} %Lehre-Studium-Forschung
...
\subsection{Wo / Wann finden Module statt?} %TODO: Bilder von Aktuellem Semester
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://campusonline.uni-ulm.de}{campusonline.uni-ulm.de}}}
...
\begin{frame}{Campusonline \space|\space Aufgabe}
    \begin{center}
        {\large Geht selber auf \href{https://campusonline.uni-ulm.de}{campusonline.uni-ulm.de} und versucht den Studienplan eures Studienganges zu finden und herunterzuladen.}
    \end{center}
\end{frame}
...
\begin{frame}{Zeitangaben}
    ...
    $\longrightarrow$ Falls es nicht explizit im Moodle steht, wird es meist in der ersten Vorlesung kommuniziert und abgestimmt. Dort könntet ihr \textbf{st} erscheinen.
...
\begin{frame}{Höhrsaalfinder \space|\space Aufgabe}
        \begin{center}
        {\large Geht selber auf \href{https://www.uni-ulm.de/einrichtungen/kiz/weiteres/campus-navigation/hoersaalfinder/}{https://www.uni-ulm.de/einrichtungen/kiz/weiteres/campus-navigation/hoersaalfinder/} und findet den nächtsten Druckraum.}
    \end{center}
\end{frame}

\subsection{Moodle} %TODO: Auch hier Bild vom Aktuellen Semester einfügen
...
\begin{frame}{\insertsubsection \space|\space Aufgabe}
    \begin{center}
        {\large Loggt euch nun in Moodle ein, schreibt euch in den Kurs ``Fachschaft Informatik'' ein und schreibe Benjamin Chladni eine Nachricht mit einem \underline{Witz}!}
    \end{center}
\end{frame}
...
\begin{frame}{\insertsubsection \space|\space Aufgabe}
    \begin{center} 
        {\large Geht selber auf \href{https://sogo.uni-ulm.de}{sogo.uni-ulm.de} und schreibt eine Mail an benjamin.chladni@uni-ulm.de mit eurer Lieblings-Programmiersprache.} 
    \end{center}
\end{frame}


\subsection{Campus4}
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://campus4.uni-ulm.de}{campus4.uni-ulm.de}}}
    \begin{itemize}
        \item Studienbescheinigungen
        \item Offene Semesterbeiträge
        \item Zahlungshistorie
        \item Wird auf lange Sicht campusonline ersetzen
    \end{itemize}
\end{frame}
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://campus4.uni-ulm.de}{campus4.uni-ulm.de}}}
    \begin{annotatedFigure}
        {\includegraphics[clip, trim={0 0 0 0}, width=\linewidth]{assets/campus4-1.png}}
        \annotatedFigureBox{0.645,0.655}{0.327,0.53}{A}{0.645,0.655}%bl
    \end{annotatedFigure}
\end{frame}
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://campus4.uni-ulm.de}{campus4.uni-ulm.de}}}
    \begin{annotatedFigure}
        {\includegraphics[clip, trim={0 0 0 0 }, width=\linewidth]{assets/campus4-2.png}}
        \annotatedFigureBox{0.01, 0.62}{0.11, 0.665}{A}{0.0, 0.605}
        \annotatedFigureBox{0.17, 0.62}{0.227, 0.665}{B}{0.17, 0.605}
        \annotatedFigureBox{0.227, 0.62}{0.315, 0.665}{C}{0.315, 0.605}
    \end{annotatedFigure}
\end{frame}


\subsection{KIZ-Drucker}
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://print.uni-ulm.de/user}{https://print.uni-ulm.de/user}}}
    \begin{fancycolumns}[T, widths={30}]
        \fancyqr[height=\linewidth]{https://print.uni-ulm.de/user}
        \nextcolumn
        \begin{itemize}
            \item Drucker sind auf dem ganzen Campus Verteilt
            \item Ihr habt ein Jährliches Freikontignent für den Zeitraum 01.01. bis 31.12.
            \item Entweder über Online-Interface Dokumente hochladen oder über KIZ PC-Pools
        \end{itemize}
    \end{fancycolumns}
\end{frame}
...
\subsection{Prüfungsplanungssystem} %TODO: Aktuelle Bilder
...
\subsection{Prüfungs- an/abmeldung} %TODO: Bild aktuelles semester
\begin{frame}{\insertsubsection \space|\space\underline{\href{https://campusonline.uni-ulm.de}{campusonline.uni-ulm.de}}}
    \begin{annotatedFigure}
...
\begin{frame}{\insertsubsection}
    \begin{itemize}
        ...
        \item Lerngruppen
        \item Body Doubles 
        \item \textbf{Altklausuren} \begin{itemize}
            \item Vor allem in Mathe sehr Wichtig
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{\insertsubsection}
    \begin{itemize}
        ...
        \item \underline{\textbf{\href{https://stuve.de/fin/aktuelles}{Fachschaft}}}: {Zusammen mit der StuVe Vertretung der Studierenden. }
...
\begin{frame}{\insertsubsection}
    ...
    \end{fancycolumns}
\end{frame}
%TODO: Erstis in die ESE-Hütte mobben (Biberach Pfarrer Riskus Haus)
%TODO: Neue Termine für Fachschaftssitzungen einfügen, wenn bekannt.
\begin{frame}{\insertsubsection (Reinschnuppern)}
    \begin{itemize}
        \item \textbf{Erste Sitzung}: 22.10 um 18:15 in O27-2203
        \item \textbf{Profabendessen}: 16.10 um 16:00 in 2201 (Erste Sitzung)
    \end{itemize}
\end{frame}

%TODO: Anmeldungslink
\begin{frame}{\insertsubsection \space|\space ESE-Hütte}
    \begin{fancycolumns}[widths={50}]
        Ihr wollt Freibier?

        Mehr Freibier als schon hier auf der ESE?

        Ihr wollt mehr miteinander Connecten?

        Dann kommt auf die ESE-Hütte!

        \begin{itemize}
            \item \textbf{Wann:} 13.11.-15.11.
            \item \textbf{Wo:} Eine Selbstversorgerhütte bei Biberach
            \item \textbf{Wie: } Anmeldung per TODO: Anmeldungsqrcode
        \end{itemize}

        \nextcolumn
        \includegraphics[width=0.6767\textwidth]{assets/huette-meme.png}
    \end{fancycolumns}
\end{frame}
...
\subsection{Probleme mit Programmieren?} %TODO: Aktuellen Moodle Kurs raussuchen und schauen ob das überhaupt noch funktioniert
\begin{frame}{\insertsubsection}
    \begin{fancycolumns}[widths={30}]
