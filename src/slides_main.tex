...
\begin{frame}{\insertsubsection (Kategorien)}
    \begin{itemize}
        ...
        \item \textbf{Vertiefungsbereicht}: Freie Modulwahl aus Katalog 
        \item \textbf{Ergänzungsbereich}: Wahl aus jedem Modul der Uni (oft aus dem ASQ Bereich)
    \end{itemize}
\end{frame}
